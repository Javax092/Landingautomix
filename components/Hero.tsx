...
export function Hero() {
  ...
  return (
    <section
      id="topo"
      className="relative min-h-[720px] overflow-hidden bg-[#050505] pt-16 sm:min-h-[760px] md:min-h-[88vh]"
    >
      <Image
      ...
      <div className="absolute inset-0 shadow-[inset_0_0_92px_rgba(0,0,0,0.68)]" />
      <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-[#050505]/70 to-transparent" />

      <div className="relative mx-auto flex min-h-[656px] max-w-7xl items-center px-5 pb-12 pt-10 sm:min-h-[696px] md:min-h-[calc(88vh-4rem)] md:px-8 md:pb-14 md:pt-12">
        <div className="hero-copy max-w-3xl">
          ...
          <div className="hero-benefits mt-10 grid max-w-3xl grid-cols-2 gap-3 sm:grid-cols-4 lg:gap-4">
            {seals.map((seal, index) => (
              <div
                key={seal}
                className="hero-seal flex min-h-[82px] items-center border border-white/12 bg-black/30 px-4 py-4 text-[0.68rem] font-semibold uppercase leading-snug tracking-[0.11em] text-zinc-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.055)] backdrop-blur-md transition duration-300 sm:min-h-[92px]"
